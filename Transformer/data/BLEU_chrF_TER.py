...
def calculate_bleu(reference_texts, hypothesis_texts):
    bleu = sacrebleu.corpus_bleu(hypothesis_texts, [reference_texts], tokenize='13a')
    return bleu.score

# File paths for reference and hypothesis texts
reference_file = "/SanHinCorp1.0/Transformer/data/ref.out"
hypothesis_file = "/SanHinCorp1.0/Transformer/data/sys.out"
