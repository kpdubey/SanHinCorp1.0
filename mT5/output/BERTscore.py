...
# File paths
reference_file = '/SanHinCorp1.0/mT5/output/test.hin_Deva'  # Replace with your reference file path
hypothesis_file = '/SanHinCorp1.0/mT5/output/generated_predictions.txt'  # Replace with your hypothesis file path
