...
# Example Usage
hindi_file = "/media/kpdubey/43a28c87-1876-4ae5-a360-9029ca34f6cd/nmt/mBART50_san-hin/data/dev/dev.san_Deva"      # Path to Hindi text file
english_file = "/media/kpdubey/43a28c87-1876-4ae5-a360-9029ca34f6cd/nmt/mBART50_san-hin/data/dev/dev.hin_Deva"  # Path to English text file
output_json = "/media/kpdubey/43a28c87-1876-4ae5-a360-9029ca34f6cd/nmt/mBART50_san-hin/data/dev/dev.json"   # Output JSON file path
