...
source_path = "/SanHinCorp1.0/OPUS-MT/test/test.sanskrit"
reference_path = '/SanHinCorp1.0/OPUS-MT/test/test.hindi'  # Replace with your reference file path
hypothesis_path = '/SanHinCorp1.0/OPUS-MT/test/test_translations.hindi'  # Replace with your hypothesis file path
